export function SearchIcon({ marginRight, active }) {
    const iconColor = active ? '#000' : 'currentColor';
    const iconWeight = active ? 600 : 'normal';

    if (!active) {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" style={{ marginRight, fontWeight: iconWeight }} aria-label="Search" className="x1lliihq x1n2onr6 x5n08af" fill={iconColor} height="24" role="img" viewBox="0 0 24 24" width="24">
                <title>Search</title>
